...
import { StateGraph, Annotation, START, END, Send, Command, StateSchema, ReducedValue } from '@langchain/langgraph'
...
const ParallelState = new StateSchema({
    ...
    results: new ReducedValue(
        z.array(z.object({ task: z.string(), result: z.string() })).default(() => []),
        {
